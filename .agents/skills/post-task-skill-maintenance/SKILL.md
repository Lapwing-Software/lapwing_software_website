...
When a completed task changes product behavior, architecture assumptions, or delivery workflow, evaluate whether the affected skills in `.agents/skills/` need a minimal update.
